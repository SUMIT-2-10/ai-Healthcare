...
exports.getFollowUpQuestion = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    if (!symptoms || typeof symptoms !== 'string') {
      throw new functions.https.HttpsError('invalid-argument', 'symptoms required');
    }
...
exports.classifyTriage = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    if (!symptoms || !followUpAnswer) {
      throw new functions.https.HttpsError('invalid-argument', 'symptoms and followUpAnswer required');
    }
